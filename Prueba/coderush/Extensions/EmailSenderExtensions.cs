    ...
    public static class EmailSenderExtensions
    {
        public static Task SendEmailConfirmationAsync(this IEmailSender emailSender, string email, string link)
        {
            return emailSender.SendEmailAsync(email, "Confirme su email",
                $"Confirme su cuenta haciendo clic en este enlace: <a href='{HtmlEncoder.Default.Encode(link)}'>link</a>"+ GetTemplateBody());
        }
        ...
        public static string GetTemplateBody()
        {
            return "<!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional//EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd\">" +
                ...
                "<img src=\"http://190.131.233.22:2021/img/Logo.png\"  /></td><td align=\"right\"><h6 class=\"collapse\"></h6></td></tr></table></div></td><td></td></tr></table><table class=\"body-wrap\"><tr>" +
                "<td></td><td class=\"container\" bgcolor=\"#FFFFFF\"><div class=\"content\"><table><tr><td><h3>Hola, BIENVENIDO A LA PRUEBA</h3><p class=\"lead\"> " +
